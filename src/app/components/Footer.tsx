      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Your personal AI-powered chef, helping you discover and create delicious recipes.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-emerald-900 font-semibold mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/generate" className="text-gray-600 hover:text-emerald-600 text-sm transition-colors">
                  Generate Recipe
                </Link>
              </li>
              <li>
                <Link href="/saved" className="text-gray-600 hover:text-emerald-600 text-sm transition-colors">
                  Saved Recipes
                </Link>
              </li>
              <li>
          ...
          {/* Resources */}
          <div>
            <h3 className="text-emerald-900 font-semibold mb-4">Resources</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/faq" className="text-gray-600 hover:text-emerald-600 text-sm transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 text-sm">
                <a href="mailto:hello@ouichef.com" className="hover:text-emerald-600 transition-colors">
                  hello@ouichef.com
                </a>
              </li>
              <li className="text-gray-600 text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-emerald-100">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} OuiChef. All rights reserved.
            </p>
